"""
=============================================================================
IDX Stock Quantitative Trading System - Unified Risk Management Engine v2026.Q3.v3.2.2
Module Name : risk.py (Institutional Production-Grade & Polars-Native Edition)
...
11. GeminiRiskDiagnosisEngine: AI Risk Diagnostic & Advisory Meta-Layer berbasis Google Gemini API (Dual Model Fallback).
...
# =============================================================================
# HELPER TIMESTAMP ZONA WAKTU INDONESIA (WIB)
# =============================================================================
...
class OperationalStateMachine:
    ...
    def transition_to(self, target_state: SystemState, source: str = "ORCHESTRATOR", reason: str = "", timestamp: str = "", trace_id: str = "", run_id: str = "", session_id: str = "") -> None:
        with self._lock:
            ...
            ts = timestamp or _get_wib_timestamp_str()
...
class GeminiRiskDiagnosisEngine:
    ...
    def run_risk_diagnosis(
        ...
        """Melakukan analisis diagnostik risiko kualitatif berbasis Google Gemini AI (Dual-Model Fallback)."""
        if not self.client:
            return {
        ...
        for model_target in [PRIMARY_MODEL, FALLBACK_MODEL]:
            try:
                ...
                logger.warning(f"⚠️ [GEMINI_RISK_DIAGNOSIS_WARN] Model {model_target} gagal: {err}")
...
class UnifiedRiskEngine:
    ...
    def evaluate_market_risk(
        ...
        ts = pipeline_timestamp or _get_wib_timestamp_str()
