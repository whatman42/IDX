...
Version       : 2026.Q3.v23.1 (Single Unified Mode & Gemini AI Advisory Layer)
...
class GeminiPortfolioDiagnosticEngine:
    ...
    def run_portfolio_advisory(
        ...
        try:
            ...
            logger.warning(f"⚠️ [GEMINI_PORTFOLIO_ADVISORY_FAILED] Error saat memanggil Gemini API: {err}")
            return {
...
class UnifiedPortfolioEngine:
    FACADE_VERSION: str = "2026.Q3.v23.1"
