...
Version       : 2026.Q3.v3.1.0 (Institutional Production-Grade Storage Engine)
...
class SQLiteEngine:
    ...
    def get_connection(self) -> sqlite3.Connection:
        if not hasattr(self._local, "conn") or self._local.conn is None:
            try:
                ...
                # PRAGMA Tuning untuk Performa Maksimal
                conn.execute("PRAGMA foreign_keys = ON;")
                conn.execute("PRAGMA journal_mode = WAL;")
                conn.execute("PRAGMA synchronous = NORMAL;")
                conn.execute("PRAGMA temp_store = MEMORY;")
                conn.execute("PRAGMA mmap_size = 30000000000;")  # 30 GB Memory Mapping Target
                conn.execute("PRAGMA cache_size = -50000;")       # ~50 MB Cache
    ...
    def init_db(self) -> None:
        def _run_init():
            ...
            try:
                # Set Auto-Vacuum sebelum pembuatan tabel pertama
                ...
                # 2. Tabel Signal History dengan UNIQUE Constraint & Signal ID Linkage
                conn.execute("""
                ...
                # 3. Indeks Komposit untuk Query Fetch Terakselerasi
                conn.execute("""
                    CREATE INDEX IF NOT EXISTS idx_signal_composite 
                        ON signal_history(asset, mode, timestamp_ns DESC);
                """)

                # 4. Tabel Prediction History dengan UNIQUE Constraint & Signal Linkage
                conn.execute("""
                ...
                if current_v < self.CURRENT_SCHEMA_VERSION:
                    ...
                    cursor.execute("""
                        ...
                        VALUES (?, ?, ?);
                    """, (self.CURRENT_SCHEMA_VERSION, "v2026.Q3.v3.1.0 Institutional Schema", now_iso))
...
class SignalHistory:
    ...
    def _prepare_signal_records(
        ...
        for sig in records:
            ...
            db_tuples.append((
                ...
                horizon_v, exp_ret, rrr_v, sig_mode, ts_ns, signal_id_str, meta_str, now_iso
            ))
    ...
    def fetch_signals(
        ...
        def _execute_fetch():
            ...
            # Decompress meta_json secara aman untuk Polars modern
...
class PredictionHistory:
    ...
    def _prepare_prediction_records(
        ...
        for pred in records:
            ...
            db_tuples.append((
                asset, pred_val, model_id, horizon_v, conf, ts_ns, signal_id_str, meta_str, now_iso
            ))
