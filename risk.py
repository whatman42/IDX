"""
=============================================================================
IDX Stock Quantitative Trading System - Unified Risk Management Engine v2026.Q3.v3.2.0
Module Name : risk.py
...
12. UnifiedRiskEngine       : Facade Class terpusat sebagai single entry point pengawasan risiko.
"""
...
class DrawdownGuard:
    ...
    def __init__(
        self,
        max_unrealized_dd: float = 0.20,
        max_realized_dd: float = 0.15,
...
# =============================================================================
# 12. UNIFIED RISK ENGINE (FACADE CLASS WITH GEMINI DIAGNOSTICS)
# =============================================================================
