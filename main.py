...
VERSION     : 2026.Q3.v2.6.3-GEMINI-AI-PATCHED
...
# =============================================================================
# HELPER: GOOGLE GEMINI AI INSIGHT ENGINE WITH COMPATIBLE MODEL STRINGS
# =============================================================================
class IDXGeminiInsightEngine:
    """
    Engine integrasi Google Gemini untuk menghasilkan analisis naratif
    kualitatif dan ringkasan eksekutif sinyal saham IDX dengan Model Fallback.
    """
    ...
    def generate_market_narrative(
        ...
        """
        Menghasilkan rangkuman narasi kuantitatif pasar saham IDX dengan hirarki fallback model.
        Memperbaiki identifier nama model dengan prefix 'models/' untuk SDK google-genai v1beta.
        """
        if not self.client:
            return ""
        ...
        # Format model identifier yang kompatibel dengan Google GenAI REST Client v1beta
        candidate_models = [
        ...
        for model_name in candidate_models:
            try:
                self.logger.info(f"🧠 Memanggil Gemini API (model: {model_name})...")
...
class ProductionOrchestrator:
    ...
    def _step_11_evaluation(self) -> None:
        try:
            ...
            # Defensive Method Dynamic Check untuk Ketersediaan Interface Evaluation Engine
            target_method = None
    ...
    def _step_12_self_learning(self) -> None:
        try:
            ...
            # Dynamic Signature Inspection agar tidak terjadi 'missing required positional arguments'
            ...
            # Pasok positional args wajib jika ada
    ...
    def _step_16_reporting(self) -> None:
        ...
        try:
            ...
            # 🟢 Generasi Narasi AI dari Google Gemini (Menggunakan Model Identifier Kompatibel)
