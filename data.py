...
- Staleness Gate: Enforced strict intra-day staleness checking for high-frequency scalping cycles.
...
IDX_MAX_HOLIDAY_STALENESS_SEC: float = 86400.0    # 24 Hours (Intraday Scalping Freshness Limit)
...
class DataLoader:
    ...
    def __init__(self, base_url: Optional[str] = None, max_workers: int = DEFAULT_MAX_WORKERS,
                 lookback_days: int = 180, max_staleness_sec: float = IDX_MAX_HOLIDAY_STALENESS_SEC) -> None:
