"""
IDX Synchronized Data Engine - Consolidated Quantitative Data Pipeline v2026.8.8
...
class UniverseLoader:
    ...
    def fetch_idx_universe(self) -> List[str]:
        # 1. Check local universe_file if explicitly provided
...
class UnifiedDataEngine:
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Direct local instantiation with universe_file support - NO INVALID IMPORTS
...
if __name__ == "__main__":
    ...
    # 1. Test Instantiation with Keyword Arguments (main.py Compatibility Test)
    engine = UnifiedDataEngine(universe_file="universe.json", cache_manager=None, extra_arg="test")
    logger.info("✔ Signature Compatibility Test Passed (universe_file parameter accepted).")

    # 2. Test Universe Fetching
    ...
    # 3. Test Data Preparation for Benchmark Ticker
    test_symbol = "BBCA.JK"
    ...
    # 4. Test Gemini AI Fallback Diagnostic
