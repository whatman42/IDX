...
Version       : 2026.Q3.v16.30 (Institutional Production-Grade & Gemini AI Integrated)
...
class GeminiNarrativeEngine:
    ...
    def generate_market_insight(self, portfolio_data: PortfolioStateDict, top_signals: List[Dict[str, Any]]) -> str:
        """Menghasilkan narasi analisis kualitatif berbasis data kuantitatif."""
        if not self.client:
            return ""
        ...
        try:
            logger.info("🧠 Memanggil Gemini API untuk membentuk narasi AI Market Insight...")
            ...
            logger.error(f"✖ Gagal menghasilkan narasi Gemini API: {e}")
            return ""
...
class SignalSummaryGenerator:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None, mode: str = "dry_run") -> None:
        ...
        self.framework_version: str = str(self.config.get("FRAMEWORK_VERSION", "2026.Q3.v16.30"))
