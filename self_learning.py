...
Description : IDX Stock Quantitative Analysis & Signal Generation
              Autonomous Self-Learning & Adaptive Feedback Loop Engine v2026.Q3.v16.2
Consolidates 12 sub-engines into a single root-level module for autonomous model learning, 
drift detection, performance tracking, model selection, retraining orchestration, and GUARANTEED disk state persistence for the Indonesian Stock Market (IDX).
...
class ConfidenceEstimator:
    ...
    def validate_estimation_inputs(
        ...
        # Adaptif memproses skema flat dict maupun nested "models" dict
        ...
        # Menyelaraskan variasi nama key (win_rate/hit_rate & error_variance/error_volatility)
...
class FeedbackEngine:
    ...
    def process_feedback_loop(
        ...
        # Sanitasi dan konversi tipe tanggal untuk perbandingan kronologis yang aman
    ...
    def _generate_downstream_telemetry(
        ...
        for row in metrics_by_model.iter_rows(named=True):
            ...
            summary["models"][mid] = {
                ...
                "hit_rate": hit_rate,
                "win_rate": hit_rate,  # Alias kompatibilitas
                "error_volatility": err_vol,
                "error_variance": float(err_vol ** 2),  # Kuadratkan untuk variance
...
class PerformanceTracker:
    ...
    def compute_rolling_metrics(
        ...
        # Menetapkan min_samples=window_size untuk mengisolasi warm-up window secara ketat
...
# =============================================================================
# 13. UNIFIED SELF-LEARNING ENGINE (FACADE CLASS WITH AUTO-PERSISTENCE)
# =============================================================================
...
class UnifiedSelfLearningEngine:
    ...
    confidence & uncertainty scoring, candidate model ranking/selection, GUARANTEED AUTOMATIC model persistence,
    ...
    def __init__(
        ...
        # Otomatis buat folder penyimpanan model jika belum ada
        self.default_model_save_path.parent.mkdir(parents=True, exist_ok=True)
        
        logger.info("UnifiedSelfLearningEngine v2026.Q3.v16.2 initialized with Auto-Persistence enabled.")
    ...
    def run_full_feedback_cycle(
        ...
        """
        Executes an integrated feedback cycle in one single call with automatic model state persistence.
        """
        start_time = time.time()
        results: Dict[str, Any] = {}

        # 0. Sanitasi Input Dataframe
        ...
        # Update Active Model State jika disediakan
        ...
        # 5. Evaluate Retraining Requirements (dengan penerusan telemetri terintegrasi)
        ...
        # 6. Trigger Auto-Save Model Checkpoint ke Disk
