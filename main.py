...
try:
    from self_evolving_agent import GodEntity, VERSION as AGENT_VERSION
...
class ProductionOrchestrator:
    def __init__(self, dry_run: bool = True, self_learning: bool = False, enable_self_evolving: bool = False) -> None:
        ...
        if self.enable_self_evolving and HAS_SELF_EVOLVING_AGENT and GodEntity is not None:
            ...
            logger.info(f"🤖 [AUTONOMOUS_AGENT] self_evolving_agent v{AGENT_VERSION} initialised (FULL EVOLUTION MODE)")
        elif self.enable_self_evolving:
            logger.warning("⚠️ self_evolving_agent tidak tersedia — nonaktifkan flag --enable-self-evolving")
        # ==========================================================================
    ...
    def _log_module_matrix(self) -> None:
        matrix = {
            ...
            "self_evolving_agent": HAS_SELF_EVOLVING_AGENT,
        }
    ...
    def _step_15_autonomous_agent(self) -> None:
        """
        Jalankan agen otonom dengan evolusi mandiri PENUH.
        Tidak ada batasan tambahan: agen dapat mengubah file sumbernya sendiri
        (self_evolving_agent.py) melalui mekanisme evolusi internal.
        """
        ...
        logger.info("▶ [STEP 15] Autonomous agent observation, planning, and full evolution")
        try:
            ...
            obs = agent.observe()
            goal = f"Optimize IDX scalping engine and self-evolve (execution_id={self.execution_id})"
            agent.set_goal(goal)
            ...
            # =================================================================
            # EVOLUSI MANDIRI PENUH — TANPA BATASAN
            # =================================================================
            logger.warning("⚡ [AUTONOMOUS] Full evolution mode ACTIVE — agent will modify its source file without restriction")
            ...
            logger.info("✔ [STEP 15] Autonomous agent finished full evolution cycle")
        except Exception as e:
    ...
    def run(self) -> None:
        ...
        try:
            ...
            self._step_15_autonomous_agent()   # <-- full evolution mode, no restrictions
            logger.info("=" * 60)
            logger.info(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--enable-self-evolving", action="store_true",
                        help="Aktifkan autonomous agent dengan evolusi mandiri PENUH (tanpa batasan)")
    ...
    orch = ProductionOrchestrator(
        ...
        enable_self_evolving=args.enable_self_evolving,   # <-- flag integrasi
    )
