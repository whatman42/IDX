...
Version       : 2026.Q3.v16.24 (Institutional Production-Grade & Hash Defensive Fix)
...
def normalize_polars_datetime(
    ...
    """
    Helper Deterministik: Mengonversi zona waktu Polars Datetime berdasarkan inspeksi metadata dtype.
    Mencegah AttributeError 'DateTimeNameSpace object has no attribute time_zone'.
    """
...
class PortfolioStateCache:
    ...
    def validate_schema(self, data: Dict[str, Any], default_capital: float) -> PortfolioStateDict:
        ...
        # REKONSILIASI MULTI-LAYER SAAT POSISI 0 SAHAM (KOSONG)
...
class TelegramRateLimiter:
    """Rate Limiter Thread-Safe untuk mencegah HTTP 429 dari Telegram API."""
...
class SignalSummaryGenerator:
    """Pemproses & Pembuat Laporan Terpadu Telegram (MarkdownV2 Compliant)."""
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None, mode: str = "dry_run") -> None:
        ...
        self.framework_version: str = str(self.config.get("FRAMEWORK_VERSION", "2026.Q3.v16.24"))
    ...
    def _calculate_payload_hash(self, raw_signals: List[Dict[str, Any]]) -> str:
        """Kalkulasi Hash SHA-256 Defensif & Deterministik untuk Integritas Payload."""
        try:
            canonical_list = []
    ...
    def build_telegram_message(self, summary_payload: ProcessedSummaryPayload, portfolio_data: Optional[PortfolioStateDict] = None) -> str:
        with self.lock:
            ...
            # REKONSILIASI KAS & EXPOSURE DIPASTIKAN PRESISI SAAT RENDERING
